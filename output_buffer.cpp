...
Output_buffer::Output_buffer(std::string filename, unsigned long buffer_size, unsigned long max_chunk_size) {
...
void Output_buffer::add_chunk(void * data, unsigned long size) {
...
void Output_buffer::write_to_file() {
    if(!out.is_open()) {
